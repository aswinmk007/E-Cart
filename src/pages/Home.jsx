    ...
    <div className='container' style={{marginTop:'150px'}}>
      { 
        ...
        <Row>
        {
          ...
          visibleCards?.map(product=>(<Col className='mb-5' sm={13} md={6} lg={4} xl={3}>
          <Card className='shadow rounded' style={{ width: '18rem' }}>
        <Card.Img style={{height:'188px'}} variant="top" src={product?.thumbnail
} />
        <Card.Body>
      ...
      <div className='d-flex justify-content-center align-items-center mt-5 mb-5'>
        <span onClick={navigateToPrevPage} style={{cursor:'pointer'}}> <i className='fa-solid fa-backward me-5 ms-5'></i></span>
        <span className='fw-bolder'>{currentPage} of {totalPages}</span>
        <span onClick={navigateToNextPage} style={{cursor:'pointer'}}> <i className='fa-solid fa-forward me-5 ms-5'></i></span>
