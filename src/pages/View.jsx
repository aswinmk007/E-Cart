...
// console.log(id);
  ...
  return (
    <>
    <Header/>
    <div style={{marginTop:'100px',height:'70vh'}} className='container d-flex align-items-center'>
      <div className="row mb-5 align-items-center">
        <div className="col-lg-6">
          <img width={'480px'} height={'400px'} className='img-fluid' src={product?.thumbnail} alt="" />
        </div>
        <div className="col-lg-6">
          ...
          <div className='d-flex justify-content-between'>
            ...
            <button onClick={()=>handleCard(product)} className='btn btn-outline-dark'><i className='fa-solid fa-cart-plus text-success'></i> Add To Cart</button>
          </div>
        </div>
      </div>
    </div>
